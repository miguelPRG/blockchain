...
class Manifest(Base):
    ...
    root_manifest_id: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
    parent_manifest_id: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
    source_record_id: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
